...
describe('User Account Recovery', () => {
  it('should successfully get a recovery code on /api/v1/users/account/local/recovery PATCH', done => {
    chai
      .request(server)
      .patch('/api/v1/users/account/local/recovery')
      .send({
  ...
  it('should successfully recover an account on /api/v1/users/account/local/recovery PUT', done => {
    chai
      .request(server)
      .put('/api/v1/users/account/local/recovery')
      .send({
        recoveryKey: user.phoneNumber,
