...
describe('User Account Password Update', () => {
  it('should fail to update account new password with current password on /api/v1/users/account/:id/account/password PUT', done => {
    chai
      .request(server)
      .put('/api/v1/users/' + user._id + '/account/password')
  ...
  it('should fail to update account password with invalid current password on /api/v1/users/account/:id/account/password PUT', done => {
    chai
      .request(server)
      .put('/api/v1/users/' + user._id + '/account/password')
      .set('Authorization', 'JWT ' + user.jwt)
  ...
  it('should fail to update account new password with weak password on /api/v1/users/account/:id/account/password PUT', done => {
    chai
      .request(server)
      .put('/api/v1/users/' + user._id + '/account/password')
      .set('Authorization', 'JWT ' + user.jwt)
  ...
  it('should successfully update account password on /api/v1/users/account/:id/account/password PUT', done => {
    chai
      .request(server)
      .put('/api/v1/users/' + user._id + '/account/password')
      .set('Authorization', 'JWT ' + user.jwt)
