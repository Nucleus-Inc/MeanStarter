...
describe('User SignIn', () => {
  it('should successfully get a JWT on /users/auth/local/jwt/signin POST', done => {
    chai
      .request(server)
      .post('/users/auth/local/jwt/signin')
      .send({
        email: user.email,
  ...
  it('should fail to get a JWT with invalid credentials on /users/auth/local/jwt/signin POST', done => {
    chai
      .request(server)
      .post('/users/auth/local/jwt/signin')
      .send({
