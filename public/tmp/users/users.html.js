angular.module("views/users/users.html",[]).run(["$templateCache",function($templateCache){
    ...
    "    <div class=\"col-md-12\">"+
    "      <div class=\"card\">"+
    "        <div class=\"card-header at-no-border\">"+
    ...
    "            <div class=\"col-md-6\">"+
    "              <div class=\"at-select-page form-group\">"+
    "                <label class=\"at-label\">Ver </label>"+
    ...
    "                </select>"+
    "                <label class=\"at-label\">itens</label>"+
    "              </div>"+
    "            </div>"+
    "            <div class=\"col-md-6\">"+
    "              <at-pagination at-list=\"usersCtrl.filteredList\" at-config=\"usersCtrl.config\" class=\"pag-table at-pagination\"></at-pagination>"+
    "            </div>"+
    "          </div>"+
    "        </div>"+
    "      </div>"+
