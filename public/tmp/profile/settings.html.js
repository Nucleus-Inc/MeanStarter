angular.module("views/profile/settings.html",[]).run(["$templateCache",function($templateCache){
    ...
    "                  <input  ng-disabled=\"true\" type=\"tel\" name=\"phoneNumber\" ng-model=\"settingsCtrl.inputs.phoneNumber\" class=\"form-control\" placeholder=\"(xx) XXXXX-XXXX\" ng-class=\"{'has-error': UpdateProfileForm.phoneNumber.$invalid && UpdateProfileForm.phoneNumber.$dirty}\" ui-br-cellphone required>"+
    ...
    "                  <input ng-model=\"settingsCtrl.account.currentPassword\" type=\"password\" name=\"currentPassword\" class=\"form-control\" ng-class=\"{'has-error': UpdatePassForm.currentPassword.$invalid && UpdatePassForm.currentPassword.$dirty}\" current-password current-email=\"{{settingsCtrl.inputs.email}}\" aria-describedby=\"passwordHelp\" required>"+
